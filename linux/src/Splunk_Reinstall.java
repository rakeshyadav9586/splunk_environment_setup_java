...
public class Splunk_Reinstall {
 ...
 public static void splunk_reintall_in_Linux(String ip, String pwd, String build_name) {
  ...
  String Splunk_new_license = Splunk_Home + "add license /opt/" + license + " -auth admin:admin123 ";
  String Splunk_old_license = Splunk_Home + "add license /opt/" + license + " -auth admin:changeme ";
  ...
  String Splunk_Restart_msg = " echo ==================================================Splunk Restarted Successfully";
  String Restart = Splunk_Restart + "&&" + Splunk_Restart_msg;
  String enable_boot_start = "/opt/splunk/bin/splunk enable boot-start";
  String command_Old = Splunk_Stop + "&&" + Splunk_Stop_msg + "&&" + Splunk_Removed + "&&" + Splunk_Removed_msg + "&&" + Splunk_untar + "&&" + Splunk_untar_msg + "&&" + Splunk_old_version + "&&" + Splunk_Start_msg + "&&" + Splunk_old_license + "&&" + Splunk_license_msg + "&&" + Splunk_old_pass_update + "&&" + Splunk_old_pass_update_msg + "&&" + Restart + "&&" + enable_boot_start;
  String command_New = Splunk_Stop + "&&" + Splunk_Stop_msg + "&&" + Splunk_Removed + "&&" + Splunk_Removed_msg + "&&" + Splunk_untar + "&&" + Splunk_untar_msg + "&&" + Splunk_new_version + "&&" + Splunk_Start_msg + "&&" + Splunk_new_license + "&&" + Splunk_license_msg + "&&" + Restart + "&&" + enable_boot_start;
  //System.out.println(command_old);
  try {
   FileWriter fileWriter = new FileWriter("Splunk_Reinstall.txt");
   ...
   System.setProperty("webdriver.chrome.driver", "G:\\My Drive\\D\\Eclipse\\Driver\\chromedriver.exe");
   ...
   System.out.println("splunk version from title is " + splunk_version);
 ...
 public static void main(String[] args) throws AWTException {
  ...
  String Splunk_7_2_0 = "splunk-7.2.0-8c86330ac18-Linux-x86_64.tgz";
  String Splunk_8_0_1 = "splunk-8.0.1-6db836e2fb9e-Linux-x86_64.tgz";
  String Splunk_8_1_0 = "splunk-8.1.0-af39d3a199ec-Linux-x86_64.tgz";
  ...
  splunk_reintall_in_Linux("10.0.0.1", "admin", Splunk_7_3_0);
